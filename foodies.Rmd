...
In this case because there are only three cities the idf could be either ln(3/3), ln(3/2) = 0.405, or 
ln(3/1) = 1.099.  So if we're looking at Chicago and the bigram is 'best pizza' and it shows up 100 times out of 1000 
