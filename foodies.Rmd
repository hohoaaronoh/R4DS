...
"eat ripe" and "ripe cataloupes".  The **tf-idf** for each bigram is exactly the same based on the height of the bars for each 
being the same. In Los Angeles we see the same thing happening right at the top of the list, "fridayfeeling flashbackfriday 
yum" and "carmelized banana split".  With a little more analysis and cleaning we could make the picture more clear.
...
carmalized banana split.  New York is happy about japanese, cheese sandwich, ingredients, but not as much as their creamiest 
...
* Tweets that were retweeted may be overreprested, it's easier to retweet and maybe the retweet happened for a reason other 
...
Limitations aside, the `tidytext` package was my first brief introduction to natural language processing and has opened to me a 
